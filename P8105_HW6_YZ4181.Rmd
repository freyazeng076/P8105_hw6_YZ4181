...
* R.squared is the measure of goodness of fit. The distribution of r.squared is slightly left-skewed, which may related to the frequency of small outliers in the bootstrap sample. The distribution of log(Bo*B1) is normal distributed around 2.01.
